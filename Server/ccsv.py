...
if __name__=='__main__':
	...
	print(arglist)
	source = " 3137"	
	sqlcmd = "select distinct route_id from raw where stop_id like "+ source +" LIMIT 1"
	outfile = None
	#optlist = "-i"
	#sqlcmd = " ".join("SELECT DISTINCT route_id FROM raw WHERE stop_id LIKE \" 3137\" LIMIT 1")
